	...
	<nav class="navbar navbar-expand-lg">
              ...
              <li> <a class="dropdown-item" href="messaging.html">Messaging</a></li>
                ...
                <a class="dropdown-item dropdown-toggle" href="#!">Profile</a>
								<ul class="dropdown-menu" data-bs-popper="none">
									<li> <a class="dropdown-item" href="{{url('user_profile')}}">Feed</a> </li>
        ...
        <li class="nav-item ms-2 dropdown">
					<a class="nav-link btn icon-md p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img class="avatar-img rounded-2" src="{{asset('assets/images/avatar/'.Auth::user()->user_detail[0]->profileImage)}}" alt="">
                       @else
                       <img class="avatar-img rounded-2" src="{{asset('assets/images/avatar/placeholder.jpg')}}" alt="">
                        @endif
                    </a>
            ...
            <li class="px-3">
              <div class="d-flex align-items-center position-relative">
                ...
                <div>
                  ...
                  @if(count(Auth::user()->user_detail)>0)
                  <p class="small m-0">{{Auth::user()->user_detail[0]->job_title}}</p>
                  @else
