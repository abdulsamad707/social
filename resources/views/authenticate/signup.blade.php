...
<!-- Mirrored from social.webestica.com/sign-up-advance.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2024 18:40:55 GMT -->
<head>
        ...
        <div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
          ...
          <div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
            ...
            <form class="mt-4" action="{{url('userregister')}}" method="POST">
              ...
              <div class="mb-3 input-group-lg">
                <input class="form-control" name="dateofbirth"  type="date"  placeholder="Confirm Password">
                <small class="text-danger">@error("dateofbirth"){{$message}}@enderror</small>
              </div>
              <div class="mb-3 input-group-lg">
                <input class="form-control" name="referalcode"  type="text"  placeholder="Enter Referal Code">
                <small class="text-danger">@error("referalcode"){{$message}}@enderror</small>
              </div>
              <!-- Keep me signed in -->
