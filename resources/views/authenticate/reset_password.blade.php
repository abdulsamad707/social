...
<!-- Mirrored from social.webestica.com/forgot-password-advance.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2024 18:40:55 GMT -->
<head>
...
<form class="mt-3" action="{{url('reset_password')}}" method="POST">
  @csrf
             <!-- New password -->
             @error("otp")
             ...
             <div class="input-group input-group-lg">
              <input class="form-control fakepassword" type="text" name="otp"  placeholder="Enter OTP">
